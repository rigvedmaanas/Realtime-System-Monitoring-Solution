...
class CTkSlideView(CTkFrame):
    def __init__(self, *args,
        ...
        self.left_anim = CTkAnimator(from_=0, to=self.w, acceleration=0.1)
        self.right_anim = CTkAnimator(from_=0, to=-self.w, acceleration=0.1)
        ...
        if self.left_anim.completed != True:
            ...
            for i, x in enumerate(self.tabs):
                ...
                if self.tabs[i][1] == self.w/2:
                    ...
                    self.current_frame = self.tabs[i]
                    self.check_callback(self.current_frame)
                else:
    ...
    def create_tab(self):
        ...
        self.current_frame = self.tabs[0]
        self.check_callback(self.current_frame)
